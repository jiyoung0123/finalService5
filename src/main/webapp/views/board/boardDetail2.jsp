                        ...
                        <div class="flex items-center space-x-5 p-7">
                            <div class="flex-1">
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control" id="boardTitle" name="boardTitle" value="항셍지수의 미래에 대해 어떻게 생각하세요?">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center space-x-5 p-7">
                            <div class="flex-1">
                                <div class="mb-3">
                                    ...
                                    <p class="leading-6 line-clamp-2 mt-3"> 오늘도 더 떨어졌네요.... </p>
                                    <p class="leading-6 line-clamp-2 mt-3"> 아침에 뉴스볼때마다 계속 놀라요  </p>
                                    <p class="leading-6 line-clamp-2 mt-3"> 내년엔 더 너무 힘들것 같아요   </p>
                                    <p class="leading-6 line-clamp-2 mt-3"> 3년전의 저는 왜이렇게 열심히 판매했던걸까요 </p>
                                    <p class="leading-6 line-clamp-2 mt-3"> 내년에는 조금이라도 올라오면 좋겠어요 </p>
                                </div>
                            </div>
                        </div>
...
<%--                    댓글 작성--%>
                ...
                <%--                    댓글 내용--%>
                    <div class="flex items-start space-x-5 p-7">
                            ...
                            <div class="flex-1">
                                <a href="#" class="text-lg font-semibold line-clamp-1 mb-1">솔직히 </a>
                                <p class="text-sm text-gray-400 mb-2"> 3112524  <span data-href="%40tag-dev.html"> </span> </span> 20231125 </p>
                                <p class="leading-6 line-clamp-2 mt-3"> 당분간은 올라오기 힘들것 같아요 ㅠㅠ </p>
                            </div>
                        </div>
                    <div class="flex items-start space-x-5 p-7">
                        <img src="assets/images/avatars/b.png" alt="" class="w-12 h-12 rounded-full">
                        <div class="flex-1">
                            <a href="#" class="text-lg font-semibold line-clamp-1 mb-1"> PB분들 힘내세요 </a>
                            <p class="text-sm text-gray-400 mb-2"> 2853414  <span data-href="%40tag-dev.html"> </span> </span> 20231125 </p>
                            <p class="leading-6 line-clamp-2 mt-3"> 다들 힘내시기 바랍니다  </p>
                        </div>
                    </div>
                    <div class="flex items-start space-x-5 p-7">
                        <img src="assets/images/avatars/d.png" alt="" class="w-12 h-12 rounded-full">
                        <div class="flex-1">
                            <a href="#" class="text-lg font-semibold line-clamp-1 mb-1"> 대책 마련이 시급합니다 </a>
                            <p class="text-sm text-gray-400 mb-2"> 2853434  <span data-href="%40tag-dev.html"> </span> </span> 20231125 </p>
                            <p class="leading-6 line-clamp-2 mt-3"> 우리는 어쩌면 좋죠? </p>
                        </div>
                    </div>
                </div>
